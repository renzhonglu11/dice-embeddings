...
@REM CALL :StartDice KGs/UMLS , ConEx
...
--use_SLCWALitModule --save_embeddings_as_csv --eval_model "train_val_test" --num_core 0 --accelerator "gpu" --devices 1
...
--save_embeddings_as_csv --eval_model "train_val_test" --num_core 0 --accelerator "cpu" --devices 1
